$( document ).ready(function() {
  ...
  looses.innerHTML = 0
  var hint = ["Every Rick needs a _____", "", "multidimensional transpotation device", 'Released in 1998 as a promo for the moive "Mulan"', "Rick's catch phrase", "the dog", "___ Smith","I'm Mr. _____ look at me!" ];
  ...
  function gameStart() {
    ...
    //Chooses word using the random number
    ...
    document.onkeyup = function(event) {
      ...
      keyPressed = key.toUpperCase()
        ...
        if (chances == 0) {
          ...
          audioLoose.src = "./assets/sounds/loose.wav";
